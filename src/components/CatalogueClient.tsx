      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-[#1E293B]">
        <div className="mx-auto flex max-w-6xl items-start gap-3 px-4 py-3">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-base font-bold leading-snug text-white">Catalogue</h1>
        ...
        <div className="rounded-2xl border border-[#D5DCE3] bg-white p-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-[#D5DCE3] bg-[#F8FAFC] py-3 pl-10 pr-3 text-sm text-slate-700 outline-none ring-0 transition-colors focus:border-[#4DA3FF]"
            />
          </div>
